   ...
   <div class="container">
      <div class="row align-items-center mt-5 mb-5">
         ...
         <div class="col-lg-5 col-md-12">
            <img class="img-fluid w-100" src="img/produtos/cone-com-alivio-g.jpg" alt="<?= $title ?>" title="<?= $title ?>">
         </div>
            ...
            <div class="box-content">
               ...
               <div class="tab-content ">
                  <div class="tab-pane active" id="tab01" role="tabpanel">
                     <p>Coluna guia cônica – Norma AFNOR</p>

                     <p>Montado com:</p>

                     <p>Bucha cônica para coluna cônica – Norma AFNOR</p>
                     <p>Arruela de fixação da coluna cônica – Norma AFNOR</p>
