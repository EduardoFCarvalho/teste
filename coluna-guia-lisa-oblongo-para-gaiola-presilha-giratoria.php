   ...
   <div class="container">
      <div class="row align-items-center mt-5 mb-5">
         ...
         <div class="col-lg-5 col-md-12">
            <img class="img-fluid w-100" src="img/produtos/coluna-lisa-com-oblongo-para-gaiola-com-presilha-giratoria-g.jpg" alt="<?= $title ?>" title="<?= $title ?>">
         </div>
            ...
            <div class="box-content">
               ...
               <div class="tab-content ">
                  <div class="tab-pane active" id="tab01" role="tabpanel">
                     <p> Coluna guia com oblongo – Lisa</p>

                     <p>Montado com:</p>

                     <p>Conjunto 1</p>
                     <p>Gaiola com limitador de altura (Alumínio)</p>
                     <p>Gaiola com limitador de altura (Bronze)</p>

                     <p>Conjunto 2</p>
                     <p>Gaiola com presilha (Alumínio)</p>
                     <p>Gaiola com presilha (Bronze)</p>
