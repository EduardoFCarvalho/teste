...
// $mail->AddAddress("vendas@jmfcomponentes.com.br");
$mail->AddAddress("suporte@bloomin.com.br");

//$mail->AddCC('teste@bloomin.com.br'); // Copia
$mail->AddBCC('formularios@bloomin.com.br', 'Inserir Nome do Cliente'); // Cópia Oculta
...
$mail->Subject  = '=?UTF-8?B?' . base64_encode("Contato - Inserir Nome do Cliente") . '?=';
