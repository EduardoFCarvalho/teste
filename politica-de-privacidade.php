...
<body>
  ...
  <section class='mt-5 mb-5 politica-de-privacidade'>
    <div class="container">
      <div class="row">
        <p>Esta Política de Privacidade e Segurança de Dados (“Política”) define as diretrizes para o tratamento e proteção das informações pessoais coletadas durante o acesso e uso do serviço de assinatura digital de contratos, prova de autenticidade de conteúdo WEB outros documentos eletrônicos.</p>
        <h2>1. ALTERAÇÕES DA POLÍTICA DE PRIVACIDADE</h2>
        
        A Empresa reserva-se o direito de, a seu exclusivo critério, modificar esta Política, incluindo novas regras, condições e/ou restrições, devendo comunicar isto ao Usuário através das plataformas de uso do Serviço, inclusive o Aplicativo e/ou o Website. A continuidade do acesso e/ou uso do Serviço pelo Usuário implicará em automática aceitação de eventuais atualizações desta.
        <h2>2. DADOS COLETADOS E SUA FINALIDADE</h2>
        
        Ao acessar o Website, independentemente de cadastro, certas informações (dados sobre o navegador utilizado, tipo de dispositivo, tempo gasto, endereço de IP, sistema operacional, navegador, idioma do navegador, fuso horário, horário local e geolocalização) serão armazenados em servidores utilizados pela Empresa.
        ...
        Além disso, a Empresa também utiliza dados para fins de marketing e comunicação, incluindo a divulgação de produtos, serviços, atividades, promoções, campanhas e eventos nos quais a Empresa tenha parte, bem como informações de suporte ao usuário, por e-mail e/ou SMS.
        <h2>3. ARMAZENAMENTO DOS DADOS</h2>
        
        As informações capturadas ficarão armazenadas e obedecem a padrões rígidos de confidencialidade e segurança, tais como a criptografia. Entretanto, é importante que o usuário tenha ciência de que pela própria natureza e características técnicas da Internet, essa proteção não é infalível e encontra-se sujeita à violação pelas mais diversas práticas maliciosas.
        ...
        No que tange ao serviço de coleta de provas sobre conteúdo online, a Empresa armazenará criptograficamente os dados referidos no tópico 3 em servidor próprio, de modo seguro e protegido contra perdas, má utilização e acessos não autorizados. Estes dados serão utilizados somente para a finalidade específica das quais foram coletados e autorizados. Os hashes dos relatórios gerados também são armazenados e vinculados às contas de cada usuário.
        ...
        A Empresa poderá compartilhar os dados pessoais coletados com seus parceiros para que este faça a autenticação notarial do relatório gerado. Note-se que esses websites possuem suas próprias políticas de privacidade, pelas quais a Empresa não é responsável.
